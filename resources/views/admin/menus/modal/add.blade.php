<div class="modal fade" id="modal_add" tabindex="-1" aria-labelledby="modalAddLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form id="form_add" class="modal-content bg-white rounded-xl shadow-xl border-0" enctype="multipart/form-data">
            ...
            <!-- Header -->
            <div
                class="modal-header bg-gradient-to-r from-emerald-500 to-green-600 text-white rounded-t-xl border-0 px-6 py-4">
            ...
            <div class="modal-body p-6 space-y-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text"
                        ...
                        name="name" placeholder="Masukkan nama menu" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200 resize-none"
                        name="description" rows="3" placeholder="Masukkan deskripsi menu" required></textarea>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="number"
                        class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200"
                        name="stok" placeholder="0" min="0" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input type="file"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition duration-200 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-emerald-50 file:text-emerald-700 hover:file:bg-emerald-100"
            ...
            <div class="modal-footer bg-gray-50 rounded-b-xl px-6 py-4 border-0">
                <button type="button"
                    class="px-6 py-2 text-gray-600 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 transition duration-200 mr-3"
                    data-bs-dismiss="modal">Batal</button>
                <button type="submit"
                    class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition duration-200 font-medium">Simpan</button>
            </div>
        </form>
    </div>
</div>
