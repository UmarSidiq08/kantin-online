    ...
    <div class="min-h-screen flex">
        <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-20 xl:px-24 bg-white">
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div class="text-center mb-8">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl transform hover:scale-105 transition-transform">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Bergabung dengan sistem kantin sekolah</p>
                </div>
                @if (session('status'))
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <textarea id="alamat"
                                class="block w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 resize-none"
                    ...
                    <div>
                        <button type="submit"
                            ...
                            <svg class="h-5 w-5 mr-2 group-hover:scale-110 transition-transform duration-200"
        ...
        <div class="hidden lg:block relative flex-1 bg-gradient-to-br from-green-500 via-green-600 to-green-700">
            <div class="absolute inset-0">
                ...
                <div
                    class="absolute top-40 left-10 w-20 h-20 bg-white opacity-10 rounded-full animate-pulse delay-300">
                </div>
                <div
                    class="absolute bottom-40 right-40 w-16 h-16 bg-white opacity-10 rounded-full animate-pulse delay-700">
                </div>
                <div
                    class="absolute bottom-20 left-20 w-40 h-40 bg-white opacity-10 rounded-full animate-pulse delay-500">
                </div>
            ...
            <div class="relative z-10 flex flex-col justify-center items-center h-full text-center px-12 text-white">
                ...
                <div class="grid grid-cols-2 gap-8 mb-8">
                    <div
                        class="bg-white bg-opacity-20 rounded-2xl p-6 backdrop-blur-sm border border-white border-opacity-30 hover:bg-opacity-25 transition-all duration-200">
                ...
                <div class="space-y-4 text-left">
                    <div class="flex items-center bg-white bg-opacity-10 rounded-lg p-3 backdrop-blur-sm">
                        <div
                            class="flex-shrink-0 w-8 h-8 bg-green-300 rounded-full flex items-center justify-center mr-3">
